...
export class UserRegistrationComponent implements OnDestroy {
  ...
  registrationForm = this.fb.group({
    ...
    email: ['', Validators.required, this.customValidation.confirmEmailValidator.bind(this.customValidation)],
      ...
      this.userService.registerUser(this.registrationForm.value)
        ...
        .subscribe(
          () => {
            ...
            console.log('Error ocurred while adding objes data : ', error);
          });
    }
  }
